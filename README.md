...
evolve-agent/
│
├── app14.py                        # Main Streamlit application (single-file)
│
├── modules/
│   ├── __init__.py
│   ├── core/
│   │   ├── __init__.py
│   │   ├── engine.py               # [Siddhartha] Evolutionary engine core
│   │   ├── fitness.py              # [Siddhartha] Fitness computation (Pacman + Matrix)
│   │   ├── cache.py                # [Siddhartha] Hash-based memoization cache
│   │   └── vdb.py                  # [Siddhartha] Vector DB (FAISS / list backend)
│   │
│   ├── mutation/
│   │   ├── __init__.py
│   │   ├── llm_mutation.py         # [Suraj] LLM-guided mutation via Gemini API
│   │   ├── random_mutation.py      # [Suraj] AST-based random mutation strategies
│   │   ├── templates.py            # [Suraj] Pacman + Matrix template library
│   │   └── prompt_builder.py       # [Suraj] Prompt engineering utilities
│   │
│   ├── evaluation/
│   │   ├── __init__.py
│   │   ├── pacman_env.py           # [Varshitha] Pacman simulation environment
│   │   ├── matrix_eval.py          # [Varshitha] Matrix multiplication evaluator
│   │   ├── logger.py               # [Varshitha] Performance logging & data collection
│   │   └── sandbox.py              # [Varshitha] Safe code execution sandbox
│   │
│   └── ui/
│       ├── __init__.py
│       ├── dashboard.py            # [Kevin] Main Streamlit UI layout
│       ├── charts.py               # [Kevin] Matplotlib chart generation
│       ├── export.py               # [Kevin] CSV / JSON / PNG export utilities
│       └── components.py           # [Kevin] Reusable UI components (metric cards, badges)
│
├── data/
│   ├── results/                    # Per-member experimental results
│   │   ├── siddhartha/             # Config 1 results, screenshots, CSV
│   │   ├── suraj/                  # Config 2 results, screenshots, CSV
│   │   ├── varshitha/              # Config 3 results, screenshots, CSV
│   │   └── kevin/                  # Config 4 results, screenshots, CSV
│   └── templates/                  # Pre-defined code templates DB
│
├── docs/
│   ├── system_architecture.png     # Architecture diagram
│   ├── ui_screenshot.png           # UI screenshot
│   └── report.docx                 # Group report (Round 1 submission)
│
├── tests/
│   ├── test_fitness.py             # Unit tests for fitness functions
│   ├── test_mutation.py            # Unit tests for mutation strategies
│   └── test_cache.py               # Unit tests for cache/VDB
│
